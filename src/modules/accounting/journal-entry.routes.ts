...
journalEntryRouter.get("/", validate({ query: paginationQuerySchema }), journalEntryController.list);
journalEntryRouter.post("/", validate({ body: createJournalEntrySchema }), journalEntryController.create);
